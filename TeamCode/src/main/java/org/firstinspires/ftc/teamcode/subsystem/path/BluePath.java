...
public class BluePath {
    ...
    public final Pose FarStartPose = new Pose(22.138385502471177, 124.06919275123559, Math.toRadians(140));
    public final Pose NearStartPose = new Pose(56.37232289950577,9.01153212520594, Math.toRadians(90));
    public final Pose FarShootPose = new Pose(59.24382207578253, 97.67874794069192,  Math.toRadians(140));
    public final Pose NearShootPose = new Pose(56.37232289950577,9.01153212520594, Math.toRadians(180));
    public final Pose EndPose = new Pose(36.309719934102134,10.846787479406943, Math.toRadians(90));
    public final Pose GatePose = new Pose(15.433278418451394,69.68039538714994, Math.toRadians(180));
    public final Pose HumanPlayerPose = new Pose(10.925864909390437,10.846787479406942, Math.toRadians(180));
    public final Pose FarPickUp1_start = new Pose(43.24052718286654,83.84184514003294, Math.toRadians(180));//From Up to Down
    public final Pose FarPickUp1_final = new Pose(16.051070840197696,83.60461285008238, Math.toRadians(180));//From Up to Down
    public final Pose FarPickUp2_start = new Pose(41.70345963756179,59.495881383855036, Math.toRadians(180));//From Up to Down
    public final Pose FarPickUp2_final = new Pose(18.05766062602966,59.258649093904445, Math.toRadians(180));//From Up to Down
    public final Pose FarPickUp3_start = new Pose(39.62932454695221,35.98023064250413, Math.toRadians(180));//From Up to Down
    public final Pose FarPickUp3_final = new Pose(14.828665568369027,35.742998352553556, Math.toRadians(180));//From Up to Down
    public final Pose NearPickUp1_start = new Pose(39.62932454695221,35.98023064250413,180);//From Down to Up
    public final Pose NearPickUp1_final = new Pose(14.828665568369027,35.742998352553556,180);//From Down to Up
    public final Pose NearPickUp2_start = new Pose(41.70345963756179,59.495881383855036,180);//From Down to Up
    public final Pose NearPickUp2_final = new Pose(18.05766062602966,59.258649093904445,180);//From Down to UP
    public final Pose NearPickUp3_start = new Pose(43.24052718286654,83.84184514003294,180);//From Down to Up
    public final Pose NearPickUp3_final = new Pose(16.051070840197696,83.60461285008238,180);//From Down to Up
