...
import static org.firstinspires.ftc.teamcode.subsystem.Constants.redAprilTag;
...
public class RedShooter {
    ...
    private void calculateShooterAngle(double robotHeading){
        relativeShootingVector = new Pose(currentPose.getX() - redAprilTag[0],
                currentPose.getY() - redAprilTag[1]);
